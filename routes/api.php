...
Route::middleware(['language', 'auth'])
    ...
    ->group(function () {
        ...
        Route::get('transactions/attendees', [MoneyTransactionsController::class, 'attendees'])
            ->name('transactions.attendees');
        Route::get('transactions/categories', [MoneyTransactionsController::class, 'categories'])
            ->name('transactions.categories');
        Route::get('transactions/secondaryCategories', [MoneyTransactionsController::class, 'secondaryCategories'])
            ->name('transactions.secondaryCategories');
        Route::get('transactions/projects', [MoneyTransactionsController::class, 'projects'])
            ->name('transactions.projects');
        Route::get('transactions/locations', [MoneyTransactionsController::class, 'locations'])
            ->name('transactions.locations');
        Route::get('transactions/costCenters', [MoneyTransactionsController::class, 'costCenters'])
            ->name('transactions.costCenters');

        Route::get('wallets/{wallet}/nextFreeReceiptNumber', [MoneyTransactionsController::class, 'nextFreeReceiptNumber'])
        ...
        Route::post('transactions/{transaction}/receipt', [MoneyTransactionsController::class, 'addReceipt'])
            ->name('transactions.addReceipt');
        Route::delete('transactions/{transaction}/receipt', [MoneyTransactionsController::class, 'deleteReceipt'])
            ->name('transactions.deleteReceipt');

        Route::post('transactions/{transaction}/controlled', [MoneyTransactionsController::class, 'markControlled'])
            ->name('transactions.markControlled');
        Route::delete('transactions/{transaction}/controlled', [MoneyTransactionsController::class, 'undoControlled'])
